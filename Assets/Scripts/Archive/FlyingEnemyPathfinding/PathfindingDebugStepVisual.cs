...
public class PathfindingDebugStepVisual : MonoBehaviour {
    ...
    public void Setup(GridSystemGenerics<FlyingEnemyPathNode> grid) {
    ...
    public void TakeSnapshot(GridSystemGenerics<FlyingEnemyPathNode> grid, FlyingEnemyPathNode current, List<FlyingEnemyPathNode> openList, List<FlyingEnemyPathNode> closedList) {
    ...
    public void TakeSnapshotFinalPath(GridSystemGenerics<FlyingEnemyPathNode> grid, List<FlyingEnemyPathNode> path) {
        GridSnapshotAction gridSnapshotAction = new GridSnapshotAction();
        gridSnapshotAction.AddAction(HideNodeVisuals);
